...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'fos_elastica.index.superjobs' => 'getFosElastica_Index_SuperjobsService',
            'fos_elastica.index.superjobs.jobs' => 'getFosElastica_Index_Superjobs_JobsService',
            'fos_elastica.index.superjobs.jobs.serializer.callback' => 'getFosElastica_Index_Superjobs_Jobs_Serializer_CallbackService',
            ...
            'fos_elastica.object_persister.superjobs.jobs' => 'getFosElastica_ObjectPersister_Superjobs_JobsService',
            ...
            'fos_elastica.provider.superjobs.jobs' => 'getFosElastica_Provider_Superjobs_JobsService',
        ...
        $this->aliases = array(
            ...
            'fos_elastica.index' => 'fos_elastica.index.superjobs',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c->addEventSubscriber(new \FOS\ElasticaBundle\Doctrine\Listener($this->get('fos_elastica.object_persister.superjobs.jobs'), array(0 => 'postPersist', 1 => 'postUpdate', 2 => 'preRemove', 3 => 'postFlush'), $this->get('fos_elastica.indexable'), array('identifier' => 'id', 'indexName' => 'superjobs', 'typeName' => 'Jobs'), NULL));
    ...
    {
        return $this->services['fos_elastica.config_manager'] = new \FOS\ElasticaBundle\Configuration\ConfigManager(array(0 => new \FOS\ElasticaBundle\Configuration\Source\ContainerSource(array('superjobs' => array('elasticsearch_name' => 'superjobs', 'reference' => $this->get('fos_elastica.index.superjobs'), 'name' => 'superjobs', 'settings' => array(), 'type_prototype' => array(), 'use_alias' => false, 'types' => array('Jobs' => array('name' => 'Jobs', 'mapping' => array('dynamic_templates' => array(), 'properties' => array()), 'config' => array('persistence' => array('driver' => 'orm', 'model' => 'Superjobs\\HomeBundle\\Entity\\Jobs', 'provider' => array('batch_size' => 100, 'clear_object_manager' => true, 'debug_logging' => true, 'query_builder_method' => 'createQueryBuilder'), 'listener' => array('insert' => true, 'update' => true, 'delete' => true, 'flush' => true, 'immediate' => false, 'logger' => false), 'identifier' => 'id', 'elastica_to_model_transformer' => array('hydrate' => true, 'ignore_missing' => false, 'query_builder_method' => 'createQueryBuilder'), 'model_to_elastica_transformer' => array()), 'serializer' => array('groups' => array()), 'index_analyzer' => NULL, 'search_analyzer' => NULL))))))));
    }
    ...
    /**
     * Gets the 'fos_elastica.index.superjobs' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getFosElastica_Index_SuperjobsService()
    {
        return $this->services['fos_elastica.index.superjobs'] = $this->get('fos_elastica.client.default')->getIndex('superjobs');
    }

    /**
     * Gets the 'fos_elastica.index.superjobs.jobs' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getFosElastica_Index_Superjobs_JobsService()
    {
        $this->services['fos_elastica.index.superjobs.jobs'] = $instance = $this->get('fos_elastica.index.superjobs')->getType('Jobs');

        $instance->setSerializer(array(0 => $this->get('fos_elastica.index.superjobs.jobs.serializer.callback'), 1 => 'serialize'));
    ...
    {
        $a = $this->get('fos_elastica.index.superjobs');

        return $this->services['fos_elastica.index_manager'] = new \FOS\ElasticaBundle\Index\IndexManager(array('superjobs' => $a), $a);
    }
    ...
    {
        return $this->services['fos_elastica.manager.orm'] = new \FOS\ElasticaBundle\Doctrine\RepositoryManager($this->get('doctrine'), $this->get('annotation_reader'));
    }
    ...
    /**
     * Gets the 'fos_elastica.object_persister.superjobs.jobs' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getFosElastica_ObjectPersister_Superjobs_JobsService()
    {
        ...
        return $this->services['fos_elastica.object_persister.superjobs.jobs'] = new \FOS\ElasticaBundle\Persister\ObjectSerializerPersister($this->get('fos_elastica.index.superjobs.jobs'), $a, 'Superjobs\\HomeBundle\\Entity\\Jobs', array(0 => $this->get('fos_elastica.index.superjobs.jobs.serializer.callback'), 1 => 'serialize'));
    }
    ...
    /**
     * Gets the 'fos_elastica.provider.superjobs.jobs' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getFosElastica_Provider_Superjobs_JobsService()
    {
        return $this->services['fos_elastica.provider.superjobs.jobs'] = new \FOS\ElasticaBundle\Doctrine\ORM\Provider($this->get('fos_elastica.object_persister.superjobs.jobs'), $this->get('fos_elastica.indexable'), 'Superjobs\\HomeBundle\\Entity\\Jobs', array('batch_size' => 100, 'clear_object_manager' => true, 'debug_logging' => true, 'query_builder_method' => 'createQueryBuilder', 'indexName' => 'superjobs', 'typeName' => 'Jobs'), $this->get('doctrine'));
    }
    ...
    protected function getFosElastica_ProviderRegistryService()
    {
        ...
        $instance->addProvider('superjobs', 'Jobs', 'fos_elastica.provider.superjobs.jobs');
    ...
    {
        $a = new \Metadata\Driver\FileLocator(array('Symfony\\Bundle\\FrameworkBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/config/serializer'), 'Symfony\\Bundle\\SecurityBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/config/serializer'), 'Symfony\\Bundle\\TwigBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/config/serializer'), 'Symfony\\Bundle\\MonologBundle' => ($this->targetDirs[3].'/vendor/symfony/monolog-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\SwiftmailerBundle' => ($this->targetDirs[3].'/vendor/symfony/swiftmailer-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\AsseticBundle' => ($this->targetDirs[3].'/vendor/symfony/assetic-bundle/Resources/config/serializer'), 'Doctrine\\Bundle\\DoctrineBundle' => ($this->targetDirs[3].'/vendor/doctrine/doctrine-bundle/Resources/config/serializer'), 'Sensio\\Bundle\\FrameworkExtraBundle' => ($this->targetDirs[3].'/vendor/sensio/framework-extra-bundle/Sensio/Bundle/FrameworkExtraBundle/Resources/config/serializer'), 'AppBundle' => ($this->targetDirs[3].'/src/AppBundle/Resources/config/serializer'), 'Superjobs\\HomeBundle' => ($this->targetDirs[3].'/src/Superjobs/HomeBundle/Resources/config/serializer'), 'Superjobs\\UserBundle' => ($this->targetDirs[3].'/src/Superjobs/UserBundle/Resources/config/serializer'), 'FOS\\UserBundle' => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/config/serializer'), 'Stfalcon\\Bundle\\TinymceBundle' => ($this->targetDirs[3].'/vendor/stfalcon/tinymce-bundle/Stfalcon/Bundle/TinymceBundle/Resources/config/serializer'), 'Knp\\Bundle\\PaginatorBundle' => ($this->targetDirs[3].'/vendor/knplabs/knp-paginator-bundle/Knp/Bundle/PaginatorBundle/Resources/config/serializer'), 'JMS\\SerializerBundle' => ($this->targetDirs[3].'/vendor/jms/serializer-bundle/JMS/SerializerBundle/Resources/config/serializer'), 'FOS\\ElasticaBundle' => ($this->targetDirs[3].'/vendor/friendsofsymfony/elastica-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\DebugBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/DebugBundle/Resources/config/serializer'), 'Symfony\\Bundle\\WebProfilerBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/config/serializer'), 'Sensio\\Bundle\\DistributionBundle' => ($this->targetDirs[3].'/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/config/serializer'), 'Sensio\\Bundle\\GeneratorBundle' => ($this->targetDirs[3].'/vendor/sensio/generator-bundle/Sensio/Bundle/GeneratorBundle/Resources/config/serializer')));
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Superjobs/UserBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
    ...
    /**
     * Gets the 'fos_elastica.index.superjobs.jobs.serializer.callback' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getFosElastica_Index_Superjobs_Jobs_Serializer_CallbackService()
    {
        $this->services['fos_elastica.index.superjobs.jobs.serializer.callback'] = $instance = new \FOS\ElasticaBundle\Serializer\Callback();
