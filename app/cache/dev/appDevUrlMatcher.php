...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (rtrim($pathinfo, '/') === '') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'superjobs_home_homepage');
            }
        ...
        if (0 === strpos($pathinfo, '/jobs') && preg_match('#^/jobs/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'superjobs_home_recruiter_job_details')), array (  '_controller' => 'Superjobs\\HomeBundle\\Controller\\RecuiterController::detailsAction',));
        }
