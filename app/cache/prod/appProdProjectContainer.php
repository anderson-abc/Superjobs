...
class appProdProjectContainer extends Container
{
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Superjobs\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['genemu.form.core.type.tinymce'] = new \Genemu\Bundle\FormBundle\Form\Core\Type\TinymceType(array('script_url' => 'asset[bundles/superjobshome/js/jquery.tinymce.js]', 'theme' => 'advanced'));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'genemu.form.tinymce.configs' => array(
                'script_url' => 'asset[bundles/superjobshome/js/jquery.tinymce.js]',
                'theme' => 'advanced',
            ),
