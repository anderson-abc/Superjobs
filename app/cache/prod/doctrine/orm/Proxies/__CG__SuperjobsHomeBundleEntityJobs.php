...
namespace Proxies\__CG__\Superjobs\HomeBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Jobs extends \Superjobs\HomeBundle\Entity\Jobs implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Superjobs\\HomeBundle\\Entity\\Jobs' . "\0" . 'id', '' . "\0" . 'Superjobs\\HomeBundle\\Entity\\Jobs' . "\0" . 'title', '' . "\0" . 'Superjobs\\HomeBundle\\Entity\\Jobs' . "\0" . 'Categories', '' . "\0" . 'Superjobs\\HomeBundle\\Entity\\Jobs' . "\0" . 'type', '' . "\0" . 'Superjobs\\HomeBundle\\Entity\\Jobs' . "\0" . 'company', '' . "\0" . 'Superjobs\\HomeBundle\\Entity\\Jobs' . "\0" . 'logo', '' . "\0" . 'Superjobs\\HomeBundle\\Entity\\Jobs' . "\0" . 'url', '' . "\0" . 'Superjobs\\HomeBundle\\Entity\\Jobs' . "\0" . 'location', '' . "\0" . 'Superjobs\\HomeBundle\\Entity\\Jobs' . "\0" . 'description', '' . "\0" . 'Superjobs\\HomeBundle\\Entity\\Jobs' . "\0" . 'skills', '' . "\0" . 'Superjobs\\HomeBundle\\Entity\\Jobs' . "\0" . 'token', '' . "\0" . 'Superjobs\\HomeBundle\\Entity\\Jobs' . "\0" . 'isPublic', '' . "\0" . 'Superjobs\\HomeBundle\\Entity\\Jobs' . "\0" . 'isCreated', '' . "\0" . 'Superjobs\\HomeBundle\\Entity\\Jobs' . "\0" . 'expiresAt', '' . "\0" . 'Superjobs\\HomeBundle\\Entity\\Jobs' . "\0" . 'createdAt', '' . "\0" . 'Superjobs\\HomeBundle\\Entity\\Jobs' . "\0" . 'updatedAt');
        }
    ...
    public function setIsCreated($isCreated)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIsCreated', array($isCreated));

        return parent::setIsCreated($isCreated);
    }
    ...
    public function getIsCreated()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIsCreated', array());

        return parent::getIsCreated();
    }
